# Structure — follow this. Do not invent a parallel tree.

Crystal Vision Source Collection drawers (Drive root `1mc0RvTCg3d94WcYIot2pLKoiHQb8nBnX`).
GitHub mirrors the **same names**. Drive = staging. This repo = kept trail.

Canon is a Crystal stamp, not a folder.
...
| 07_CELESTIAL_PORTAL | [folder](https://drive.google.com/drive/folders/11iytHl9SQtFW6ECQMAeaanJhM0nO7_n6) | `07_CELESTIAL_PORTAL/` + `handoff/celestial-portal/` + `backend/` + `apps/` · stack: `00_MASTER_INDEX/STACK-SURFACE.md` |
...
- **Songline** never a component (wrong name here). Project term is **Starline**. Law: [`00_MASTER_INDEX/NAMING-STARLINE.md`](00_MASTER_INDEX/NAMING-STARLINE.md).
- Connection ≠ merge.
