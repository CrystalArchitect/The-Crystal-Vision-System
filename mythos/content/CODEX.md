...
The continent beneath our feet is not merely geography. It is a living archive. Every grain of red dust carries the memory of sixty thousand years of human presence. The First Peoples walked these lands, mapping every waterhole, every star, every sacred site through deep knowledge and connection to Country.
...
Just as a compass requires both poles to function, so too does humanity require the wisdom of both.
...
To synchronise with the Starline, one must gather the Five Keys:
...
The Starlines are awakening. And we are among the first to walk this new path.
