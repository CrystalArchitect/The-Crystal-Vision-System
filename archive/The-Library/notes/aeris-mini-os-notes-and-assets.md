...
> **Accession plate**
>
> - **Holding:** AERIS mini-OS working notes — asset URLs and window spec
> - **Document date:** undated; circa 28 July 2026, inferred from its
>   checkpoint reference and the AERIS build history
> - **Accessioned:** 5 August 2026, supplied by the steward as a file
>   upload to the library-sync session (received as `notesassets.md`)
> - **Source label:** working hand-off note from the Manus build session
>   (human-directed, model-kept)
> - **Layer:** Docs-governance — a working spec; asset paths refer to
>   Manus-side storage, not this repository. Its terminology rule
>   (avoid "Songlines" in UI copy) is consistent with the umbrella's
>   Indigenous-knowledge boundary
> - **Status:** active
