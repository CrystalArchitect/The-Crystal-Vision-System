...
> **Accession plate**
>
> - **Holding:** Crystal Ecosystem — Full Repository Review
> - **Document date:** 29 July 2026 (self-dated)
...
> - **Source label:** model (Manus AI) — a review of clones taken
>   29 July 2026; its claims are the reviewer's, checked against that day
> - **Layer:** Claim — accurate to its date and partly overtaken since:
>   the repositories it calls `crystalcore` and `The-Crystal-Vision` now
>   carry the GitHub names `TheCrystalVision` and
>   `Clementine---Local-Soveriegn-Edge-AGI` respectively, and
>   `crystal-vision` was renamed `CrystalCore-Starlines-and-Dreamlines`
>   on 2026-07-29. See `records/2026-08-05-library-sync.md`
> - **Status:** active, with noted drift
