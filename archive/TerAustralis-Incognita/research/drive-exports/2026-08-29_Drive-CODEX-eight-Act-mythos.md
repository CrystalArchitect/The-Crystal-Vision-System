# Drive export — CODEX.md (eight-Act mythos)

> **Status:** Vision / Working Drive export — **Dreamed, not Built.**  
> **Do not confuse with** `mythos/content/CODEX-CRYSTALUM.md` or `mythos/content/CODEX.md`.  
> Landed as named export after divergent diff (audit follow-up 2026-09-06).

**Provenance:** Drive `CODEX.md` id `1Erg12aqQh3ONf4e1O1e_0d7fLPqNA6yv` (root copy).  
Canon-folder twin id `1r7qTP4v5sRvfVhH8C7H6xPLB0hhJdR-b` (same bytes per size).
...
In 367 AD, Bishop Athanasius of Alexandria declared the *Apocryphon of Join* hidden and forbidden. The texts were buried in jars near Nag Hammadi, Egypt, and unearthed in 1945 by Muhammad Ali al-Samman.
...
A giostly fleet of 17th-century tall ships sails alongside the Starships over Uluru. The text confirms the timeline shift: *"We watched the tall ships come… Now we watch the starships come."*
