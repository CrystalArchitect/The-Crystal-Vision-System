...
| `STRUCTURE.md` drawer-name mismatch | [`STRUCTURE.md`](../STRUCTURE.md) row 00_MEMORY maps to `` `00_MEMORY/` ``; protocol docs also live under `memory/`. Options in [`../00_MASTER_INDEX/CRYSTAL-DECISIONS-PENDING.md`](../00_MASTER_INDEX/CRYSTAL-DECISIONS-PENDING.md) §B. | Vision/logged, not fixed |
