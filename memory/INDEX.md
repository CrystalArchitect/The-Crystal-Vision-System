...
Load CORE, then only the row you need.
...
| Equation page | https://drive.google.com/file/d/1PtsHESYsJm8SwbgJ00EAGUHkQTH81LAE/view | FOUND. JPEG 13 Aug. Not transcribed |
| SAT stack | docs/SAT-STACK.md | figure-1 labels, not running hardware |
| Portal A | docs/PORTAL-A.md | AI Studio react-example bytes |
| Ledger | docs/LEDGER.md | sitting status |
| Collection Mode card | Drive 1gZZRWGvtldDLSeGlZwq4zkOsqZn6oiwS | already 3 copies |
