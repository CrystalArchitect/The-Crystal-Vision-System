...
One working index for this repo. Do not start a second index.

See [`WORKING-INDEX.md`](WORKING-INDEX.md).  
...
**Starline naming:** [`NAMING-STARLINE.md`](NAMING-STARLINE.md) — *spread the bird, not the word — because the bird is the word.*
