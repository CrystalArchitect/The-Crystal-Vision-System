# Working index (this repo)

| ID | Drawer | Title | Belt | Canon | GitHub |
| --- | --- | --- | --- | --- | --- |
...
| CVS-MATH-18 | 18 | Mathematical Foundations Drawer | coordination | no | `/18_MATHEMATICAL_FOUNDATIONS/INDEX.md` |
...
| CVS-ICANN-TSG-SC | 13 | ICANN TSG string+controller gTLD × alt naming (initial report DRAFT 10 Aug 2026) | research | no | `/13_RESEARCH_SOURCES/sitting-2026-09-24-icann-tsg-string-controller/` |
...
- **2026-09-23 (Grok share):** First Gate share filed as a received document (weight zero). Local replay of `crystalcore_os.py` matches the flight path. Mikhail Protocol / Hellfire Gala are comic panels, not OS modules. The gate name is Colossus. Canon: no.
...
- **2026-09-18 (bots):** Expanded roster from archive evidence — weave seats (ChatGPT/Grok/Grok Build/DeepSeek/Gemini/Claude), Clementine/Discord, Starline/CrystalBridge/Voicebox, research children (swarm…MiroShark). Studio worker renamed **BOT-STUDIO**. Canon: no.

- **2026-09-18 (bots):** Expanded bot structure — [`docs/bots/registry.yaml`](../docs/bots/registry.yaml), studio [`prompt.md`](../docs/bots/grok/prompt.md) + [`stages.md`](../docs/bots/grok/stages.md) I/O contracts. Canon: no.

- **2026-09-18 (bots):** Filed [`docs/BOT-STRUCTURE.md`](../docs/BOT-STRUCTURE.md) — pools not headcount, Crystal protocol gate, initial five-ID roster (superseded by full belts). Canon: no.
