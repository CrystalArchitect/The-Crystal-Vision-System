# Starfleet Australia — Kangaroo Division

**Canon:** **no**  
**Layer:** vision / coordination  
**Stamp:** **LAUNCHED** 2026-09-20  
**Division callsign:** Kangaroo Division · class fiction **NCC-992-AU**  
**Law:** Vision ≠ Built. Connection ≠ merge. No Starship MoU. No false Elon/xAI bonds. Human publishes.
...
**Academy brand (working, Vision):** **Starfleet Academy — Kangaroo Division** — education face of this Division. Optional Harry Potter *structure* skin for youth recruitment only (no licensed names). See sitting addendum `13_RESEARCH_SOURCES/sitting-2026-09-23-beyond-lucky-overlap/ADDENDUM-academy-brand-faces.md`.
...
| Piece | Status | Where |
| --- | --- | --- |
| Pitch pack (archive) | ● on disk | `archive/starfleet-au-kangaroo-pack/` |
| One-pager / spec / factcheck / nodes | ● | `01`–`04` in pack |
...
| File | Role |
| --- | --- |
| `01-PITCH-ONE-PAGER.md` | Thesis for SpaceX / SpaceXAI ask |
| `02-SPEC-SHEET.md` | Systems |
| `03-FACTCHECK.md` | Claims hygiene |
| `04-INDUSTRIAL-NODES.md` | Eight AU nodes key |
