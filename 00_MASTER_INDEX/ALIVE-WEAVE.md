...
- **Songline** as a CVS **component** or product title — forever out of bounds (`CVS-SONGLINE`). Project name for the related protocol/mythos thread is **Starline** (`CVS-STARLINE` / Consent Transport). Law: [`NAMING-STARLINE.md`](NAMING-STARLINE.md).
...
- [`STARFLEET-AU-KANGAROO-DIVISION.md`](STARFLEET-AU-KANGAROO-DIVISION.md) — Kangaroo Division launch (Vision)  
