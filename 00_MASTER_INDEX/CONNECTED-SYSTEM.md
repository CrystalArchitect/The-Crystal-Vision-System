...
- Filing rules from root README still apply: one collector, one working index, extracts not chat dumps, say **Starline** ([`NAMING-STARLINE.md`](NAMING-STARLINE.md)), **connection ≠ merge**.
