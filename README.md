...
**Naming:** say **Starline** (Consent Transport / Starlines). **Songline** is never a title or component — [`00_MASTER_INDEX/NAMING-STARLINE.md`](00_MASTER_INDEX/NAMING-STARLINE.md).
