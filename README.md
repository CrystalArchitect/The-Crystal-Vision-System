...
**Naming:** **Starline** — Consent Transport / Starlines. See [`00_MASTER_INDEX/NAMING-STARLINE.md`](00_MASTER_INDEX/NAMING-STARLINE.md). *Spread the bird, not the word — because the bird is the word.*
