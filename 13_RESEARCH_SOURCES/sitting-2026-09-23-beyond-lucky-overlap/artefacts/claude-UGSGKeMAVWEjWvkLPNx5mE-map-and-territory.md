...
> **Sitting artefact copy** (24 Sep 2026) of the Claude share  
> https://claude.ai/artifact/UGSGKeMAVWEjWvkLPNx5mE  
> Source path in archive: `archive/TerAustralis-Incognita/docs/reviews/2026-07-23-architecture-survey.md`  
> Do not edit this copy for content drift — update the archive/docs repo and re-copy if the survey is revised.
