...
```mermaid
flowchart TB
  subgraph public [Public voice]
    SN[SpaceNews May 2026]
    ATR[After the radar Sep 2026]
    TA[TerAustralis.com.au CrystalCore.OS]
    Grok[Grok Sydney Hall pack]
  end
  subgraph thesis [Industrial thesis on disk]
    FS[Full Stack / Sovereign Capability]
    Catch[Catch / Multi-node / Pilbara]
    Aero[Aerotropolis West / Westmead BCI]
  end
  subgraph surfaces [Adjacent surfaces]
    ManusEgg[Manus Web OS easter egg]
...
| [`RELEASE-DRAFT-protect-people-systems-protocols.md`](RELEASE-DRAFT-protect-people-systems-protocols.md) | Protect-people public note — **INTERNAL ECHO ONLY** Slack 1-member · 24 Sep 2026 |
...
| [`SOURCE-news-appin-ps-house-rename-2026-09-24.md`](SOURCE-news-appin-ps-house-rename-2026-09-24.md) | Appin PS sport houses → Mabo/Freeman/Mauboy/Goodes; Crystal alumni note |
