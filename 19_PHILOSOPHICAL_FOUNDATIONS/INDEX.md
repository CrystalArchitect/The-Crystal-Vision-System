...
- Axiom testing and validation
- Claim lifecycle management (active → weakened → superseded → retracted)
- Formal ontology for AI systems
- Emergence and irreversibility in distributed systems
...
- **Emergence**: Properties that appear only at system level
- **Subjectivity**: Experience is foundational to agency
...
- [[20_ECONOMIC_MODELS]] — Applied economic models from foundations
